...
| `parts_v2_sample.csv` | CSV UTF-8 | Schema drift — `uom` moved before `category`; extra null `legacy_ref` column |
| `suppliers_legacy_sample.csv` | CSV (Windows-1252 in full export) | Near-duplicate supplier names and malformed emails |
